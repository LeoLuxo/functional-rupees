...
CreateConVar( "gmod_functional_rupees_armor", "0", FCVAR_ARCHIVE, "Defines if rupees give armor instead of health")
CreateConVar( "gmod_functional_rupees_cap", "200", FCVAR_ARCHIVE, "Defines the health / armor cap. 0=disabled")